 ...
 * the number, the frequently the mover will turn. The turn width is the widest turn the mover will take  
 * in degrees, so should be less than or equal to 360. To make your actor have a speed of five with 25 percent chance 
 * of turning and a maximum turn width of 30 degrees, use this code:</p> 
 * 
 * <p style = "font-weight: bold">moverandomly.moveRandomly(4, 25, 30);</p> 
 * 
 * @author Jim Stewart 
 * @version 1.0
 */
public class MoveRandomly extends Actor
{
    ...
    {
        mover.turn(Greenfoot.getRandomNumber(turnWidth));        
    }
}
