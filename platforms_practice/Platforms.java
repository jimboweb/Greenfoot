...
public class Platforms extends World
{
    ...
    int bottomBound = getHeight();  //MAPHEIGHT;           //Where the bottom of the screen is on the map
    int topBound = 0;               //MAPHEIGHT - getHeight(); //Where the top of the screen is on the map
    int rightBound = getWidth();            //Where the right side of the screen is on the map
    BallGuy ballguytemplate = new BallGuy(0,0,0,0);
    BallGuy ballguy = new BallGuy(200,200,200,200);
