...
public class PlatformWorld extends World
{
    ...
    private void prepare()
    {
        ...
        addObject(platformopponent, 652, 470);
        PlatformOpponent platformopponent2 = new PlatformOpponent();
        addObject(platformopponent2, 277, 375);
        PlatformOpponent platformopponent3 = new PlatformOpponent();
        addObject(platformopponent3, 577, 300);
        Door door = new Door();
        addObject(door, 766, 35);
        PlatformOpponent platformopponent4 = new PlatformOpponent();
        addObject(platformopponent4, 83, 251);
        PlatformOpponent platformopponent5 = new PlatformOpponent();
        addObject(platformopponent5, 226, 245);
        PlatformOpponent platformopponent6 = new PlatformOpponent();
        addObject(platformopponent6, 471, 156);
        PlatformOpponent platformopponent7 = new PlatformOpponent();
        addObject(platformopponent7, 647, 158);
        PlatformOpponent platformopponent8 = new PlatformOpponent();
        addObject(platformopponent8, 407, 32);
        PlatformOpponent platformopponent9 = new PlatformOpponent();
        addObject(platformopponent9, 82, 93);
        platformopponent7.setLocation(647, 148);
        platformopponent6.setLocation(472, 147);
        platform7.setLocation(411, 298);
        platform7.setLocation(411, 298);
        platformopponent5.setLocation(337, 247);
        removeObject(platform12);
        removeObject(platform20);
        removeObject(platformopponent8);
        removeObject(platformopponent7);
        removeObject(platformopponent5);
        removeObject(platformopponent2);
        removeObject(platformopponent);
        removeObject(platformopponent3);
    }
}
