...
public class Sand extends World
{
        ...
        Republicans hidden = new Republicans(5, mover);
    ...
    private void prepare()
    {
        ...
        addObject(mover, 209, 180);
        Republicans republicans = new Republicans(5, mover);
        addObject(republicans, 406, 111);
        addObject(button, 354, 311);
    }
