...
public class ScoreBoard extends Actor
{
    ...
    {    
        setImage(new GreenfootImage(Math.max(width, width), height)); 
    ...
    private void drawScores()
    {
        ...
        drawString("All Players", 80, topSpace - HEADER_TEXT_HEIGHT - 5, MAIN_COLOR, HEADER_TEXT_HEIGHT);
        drawString("Near You", 80 + getImage().getWidth() / 2, topSpace - HEADER_TEXT_HEIGHT - 5, MAIN_COLOR, HEADER_TEXT_HEIGHT);  
    ...
    private void drawUserPanel(int left, int top, int right, int bottom, List users)
    {
        ...
        getImage().fillRect(left, top, right - left, bottom - top);
