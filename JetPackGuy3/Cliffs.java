...
public class Cliffs extends World
{
    ...
    private void prepare()
    {
        for(int i=0;i<coords.length;i++)
        {
            ...
            if(coords[i][0]>0 && coords[i][0]<getWidth() && coords[i][1]>0 && coords[i][1] < getHeight())
            {
                addObject(thePlatforms.get(i), coords[i][0], coords[i][1]);
            }
    ...
    public void moveWorld(int amount)
    {
        for(int i=0;i<coords.length;i++)
        {
            ...
            if(coords[i][0]>0 && coords[i][0]<getWidth() && coords[i][1]>0 && coords[i][1] < getHeight())
            {
                ...
                {
                    addObject(thisPlatform, coords[i][0], coords[i][1]);
                } else {
                    thisPlatform.setLocation( coords[i][0], coords[i][1]);
                }
