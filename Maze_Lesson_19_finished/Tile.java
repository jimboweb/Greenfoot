...
public class Tile extends World
{
    ...
    private void prepare()
    {
        ...
        addObject(cheese, 583, 277);
        Cheese cheese2 = new Cheese();
        addObject(cheese2, 581, 30);
        Cheese cheese3 = new Cheese();
        addObject(cheese3, 284, 31);
        Cheese cheese4 = new Cheese();
        addObject(cheese4, 88, 383);
        Cheese cheese5 = new Cheese();
        addObject(cheese5, 333, 385);
        Cheese cheese6 = new Cheese();
        addObject(cheese6, 527, 391);
        Cheese cheese7 = new Cheese();
        addObject(cheese7, 336, 286);
    }
}
